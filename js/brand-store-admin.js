...
// TOMA
// BRAND STORE ADMIN
// BLOC 11 — JOURNAL D'ADMINISTRATION + HISTORIQUE
...
alert(
    "BLOC 11 — Carregamento do journal de administração..."
);
...
const adminLogTypeFilter =
    document.getElementById(
        "adminLogTypeFilter"
    );

const adminLogClearButton =
    document.getElementById(
        "adminLogClearButton"
    );

const adminLogRefreshButton =
    document.getElementById(
        "adminLogRefreshButton"
    );
...
const adminLogSecurity =
    document.getElementById(
        "adminLogSecurity"
    );

const adminLogLastAction =
    document.getElementById(
        "adminLogLastAction"
    );
...
const adminLogDetailsModal =
    document.getElementById(
        "adminLogDetailsModal"
    );

const closeAdminLogDetails =
    document.getElementById(
        "closeAdminLogDetails"
    );

const adminLogDetailsContent =
    document.getElementById(
        "adminLogDetailsContent"
    );
...
// ==========================================================
// UTILITAIRE — NORMALISER TEXTE
// ==========================================================

function normalizeAdminLogText(
    value
) {
...
// ==========================================================
// UTILITAIRE — TYPE D'ACTION
// ==========================================================

function getAdminLogType(
    log
) {
...
// ==========================================================
// UTILITAIRE — LABEL TYPE
// ==========================================================

function getAdminLogTypeLabel(
    type
) {
...
// ==========================================================
// UTILITAIRE — NIVEAU DE SÉCURITÉ
// ==========================================================

function getAdminLogSecurityLevel(
    log
) {
...
// ==========================================================
// Cette fonction est importante car le Bloc 9 l'utilise déjà
// avec :
//
// window.brandStoreAdmin.saveStoreActivity(...)
// ==========================================================
...
async function saveStoreActivity(
    ...
    try {
        ...
        // --------------------------------------------------
        // IMPORTANT
        // Le journal ne doit pas bloquer une action
...
// ==========================================================
// UTILITAIRE — NIVEAU PAR DÉFAUT
// ==========================================================

function getDefaultSecurityLevel(
    type
) {
...
async function loadAdminLogs() {
    ...
    try {
        ...
        try {
            ...
            console.warn(
                "BLOC 11 — Consulta ordenada falhou:",
                error
            );
            ...
            try {
                ...
                console.warn(
                    "BLOC 11 — Consulta fallback falhou:",
                    fallbackError
                );
        ...
        window.brandStoreAdmin.adminLogs =
            adminLogs;
        ...
        console.error(
            "BLOC 11 — Erro ao carregar journal:",
            error
        );
...
// ==========================================================
// FONCTION — FILTRER LE JOURNAL
// ==========================================================

function filterAdminLogs() {

    const search =
        normalizeAdminLogText(
...
adminLogSearch?.addEventListener(
    "input",
    event => {
...
adminLogTypeFilter?.addEventListener(
    "change",
    filterAdminLogs
);
...
function renderAdminLogs() {
    ...
    if (
        ...
        renderEmptyState(
            ...
            "As ações administrativas desta Loja Oficial aparecerão aqui."
        );
            ...
            log => {
                ...
                return `
                    ...
                    >
                        ...
                        <div class="adminLogIcon ${securityLevel}">
                        ...
                        <div class="adminLogContent">

                            <div class="adminLogHeader">
...
// ==========================================================
// FONCTION — ACTION JOURNAL
// ==========================================================

function handleAdminLogAction(
    event
) {
...
// ==========================================================
// FONCTION — DÉTAIL JOURNAL
// ==========================================================

function openAdminLogDetails(
    log
) {
    ...
    adminLogDetailsContent.innerHTML = `

        <div class="adminLogDetails">
...
closeAdminLogDetails?.addEventListener(
    "click",
    () => {
...
adminLogDetailsModal?.addEventListener(
    "click",
    event => {
...
// ==========================================================
// FONCTION — SUPPRIMER UN LOG
// ==========================================================

async function deleteAdminLog(
    log
) {
    ...
    try {
        ...
        const confirmation =
            confirm(
                "Deseja excluir este registro administrativo?"
            );
        ...
        console.error(
            "BLOC 11 — Erro ao excluir log:",
            error
        );


        alert(
            "BLOC 11 — ERRO ao excluir registro:\n\n" +
            error.message
        );
...
async function clearAdminLogs() {
    ...
    try {
        ...
        const confirmation =
            confirm(
                "ATENÇÃO!\n\n" +
                "Isso excluirá todos os registros administrativos desta Loja Oficial.\n\n" +
                "Deseja continuar?"
            );
        ...
        showLoading(
            "Limpando journal administrativo..."
        );
        ...
        // DELETE SEQUENTIEL
        // --------------------------------------------------
        // Pour rester compatible avec le code actuel,
        // on supprime les documents un par un.
        // --------------------------------------------------
        ...
        showToast(
            "Journal administrativo limpo com sucesso.",
            "delete"
        );
        ...
        // --------------------------------------------------
        // Note: on ne l'enregistre pas ici, puisque le
        // journal vient d'être entièrement supprimé.
        // --------------------------------------------------
        ...
        alert(
            "BLOC 11 — ERRO ao limpar journal:\n\n" +
            error.message
        );
...
adminLogClearButton?.addEventListener(
    "click",
    clearAdminLogs
);
...
// ==========================================================
// ÉVÉNEMENT — ACTUALISER
// ==========================================================

adminLogRefreshButton?.addEventListener(
    "click",
    async () => {
...
function updateAdminLogCounters() {
    ...
    if (adminLogSecurity) {
        ...
        adminLogSecurity.textContent =
            security;

    }


    if (adminLogLastAction) {

        adminLogLastAction.textContent =
            last?.title ||
            "Nenhuma";
...
window.brandStoreAdmin.loadAdminLogs =
    loadAdminLogs;

window.brandStoreAdmin.filterAdminLogs =
    filterAdminLogs;

window.brandStoreAdmin.openAdminLogDetails =
    openAdminLogDetails;

window.brandStoreAdmin.deleteAdminLog =
    deleteAdminLog;

window.brandStoreAdmin.clearAdminLogs =
    clearAdminLogs;
...
alert(
    "BLOC 11 — Journal de administração carregado com sucesso."
);
