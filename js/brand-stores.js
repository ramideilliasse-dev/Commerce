...
// TOMA
// BRAND STORES
// BLOC 9 — CONNEXION DES ACTIONS ADMINISTRATIVES
// ==========================================================
...
alert(
    "BLOC 9 — Conexão das ações administrativas démarrée."
);
...
if (!window.brandStoresData) {
    ...
    alert(
        "BLOC 9 — ERRO : brandStoresData inexistente."
    );

    throw new Error(
        "BLOC 9 : brandStoresData introuvable."
    );

}


if (!window.brandStoresAdminActions) {

    alert(
        "BLOC 9 — ERRO : ações administrativas inexistentes."
    );

    throw new Error(
        "BLOC 9 : brandStoresAdminActions introuvable."
    );
...
alert(
    "BLOC 9 — Comunicação com os Blocos 1 à 8 confirmada."
);
...
const adminEditStoreButton =
    document.getElementById(
        "editStoreButton"
    );


const adminVerifyStoreButton =
    document.getElementById(
        "verifyStoreButton"
    );


const adminToggleStatusButton =
    document.getElementById(
        "toggleStoreStatusButton"
    );
...
// ==========================================================
// FONCTION — VÉRIFIER LA LOJA SÉLECTIONNÉE
// ==========================================================
...
function requireSelectedStore() {
    ...
    if (!selectedStore) {
        ...
        alert(
            ...
            "BLOC 9 — Nenhuma Loja selecionada.\n\n" +

            "Volte à página Brand Stores e selecione uma Loja."
...
// ==========================================================
// BOUTON — MODIFIER LA LOJA
// ==========================================================

adminEditStoreButton?.addEventListener(
    "click",
    () => {
...
// ==========================================================
// BOUTON — VÉRIFIER LA LOJA
// ==========================================================

adminVerifyStoreButton?.addEventListener(
    "click",
    () => {
        ...
        alert(
            ...
            "BLOC 9 — Ação VERIFICAR preparada.\n\n" +
...
adminToggleStatusButton?.addEventListener(
    "click",
    () => {
        ...
        if (
            ...
            alert(
                ...
                "BLOC 9 — Ação SUSPENDER preparada.\n\n" +
        ...
        alert(
            ...
            "BLOC 9 — Esta Loja ainda está disponível.\n\n" +

            "Nenhuma suspensão é necessária."
...
adminSettingsButton?.addEventListener(
    ...
    () => {
        ...
        alert(
            ...
            "BLOC 9 — Ação CONFIGURAÇÕES preparada.\n\n" +
...
const buttonStatus = {
    ...
    edit:
        Boolean(
            adminEditStoreButton
        ),

    verify:
        Boolean(
            adminVerifyStoreButton
        ),

    toggle:
        Boolean(
            adminToggleStatusButton
        ),
...
// ==========================================================
// ALERTE — ÉTAT DES BOUTONS
// ==========================================================

alert(

    "BLOC 9 — Botões administrativos verificados.\n\n" +
...
alert(
    "BLOC 9 — Conexão das ações administrativas terminado com sucesso."
);
